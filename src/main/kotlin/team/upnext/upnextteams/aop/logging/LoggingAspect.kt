package team.upnext.upnextteams.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(team.upnext.upnextteams.repository..*)" +
            " || within(team.upnext.upnextteams.service..*)" +
            " || within(team.upnext.upnextteams.web.rest..*)"
    )
